...
// Wave 3 lands `intel/` and `virtio/` modules in morpheus-nic. Until then
// the `crate::{intel, virtio}` paths are forward-references.
use crate::intel::{E1000eDriver, E1000eError};
use crate::traits::{MacAddress, NetworkDriver, RxError, TxError};
