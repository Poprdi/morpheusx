...
impl InstallerMenu {
    ...
    fn scan_for_esps(&mut self, bs: &BootServices) {
        ...
        for disk_idx in 0..disk_count {
            ...
            if morpheus_core::disk::gpt_ops::scan_partitions(
                adapter,
                &mut partition_table,
                block_size,
            )
    ...
    fn install_to_selected(
        ...
        let loaded_image =
            unsafe { crate::uefi::file_system::get_loaded_image(bs, self.image_handle) };
