...
/// Manifest magic: "MXISO\x01\x00\x00" (v1 - compatible with morpheus_storage_format)
...
impl ManifestWriter {
    ...
    pub fn write_to_esp_fat32<B: BlockIo>(
        ...
        let _ = morpheus_storage_format::fs::create_directory(block_io, esp_start_lba, "/.iso");

        // Write manifest file
        morpheus_storage_format::fs::write_file(block_io, esp_start_lba, &path, &buffer[..len])
