...
mod tests {
    ...
    fn cube_mesh_has_expected_corners() {
        ...
        assert_eq!(unique_count, 8, "cube should have exactly 8 unique corner positions");
    }
    ...
    fn cube_rotation_and_uniform_scale_are_rigid() {
        ...
        for step in 0..360u32 {
            ...
            let transform = Mat4::rotation_y(s, c).mul(&Mat4::scale(scale_val, scale_val, scale_val));
