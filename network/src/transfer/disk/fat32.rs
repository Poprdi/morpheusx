...
impl Fat32Formatter {
    ...
    pub fn format<B: BlockIo>(
        ...
        // Calculate FAT size
        let fat_size = Self::calculate_fat_size(total_sectors, reserved_sectors, sectors_per_cluster);
        ...
        for i in 0..sectors_per_cluster as u64 {
            block_io.write_blocks(Lba(data_start + i), &empty_sector)
                .map_err(|_| DiskError::IoError)?;
        }
