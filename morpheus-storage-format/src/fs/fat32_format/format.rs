...
impl Fat32BootSector {
    fn new(total_sectors: u32, fat_size: u32, hidden_sectors: u32) -> Self {
        ...
        // Stub legacy boot code: BIOS teletype 'M' then HLT. Some firmware
        // sniffs this for sanity even though we never legacy-boot.
...
pub fn format_fat32<B: BlockIo>(
    ...
    // -1 for the root cluster.
    let fsinfo = FsInfoSector::new(cluster_count - 1);
