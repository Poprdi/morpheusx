// NIC I/O syscalls + ioctl/mount/umount/poll.

use super::common::*;
use super::core::sys_sleep;
use super::fb::is_composited_client;
use super::nic_fb::{fb_registered, NicInfo, NIC_OPS};
use crate::pipe;
use crate::schedular::SCHEDULER;
use morpheus_helix::types::open_flags::O_PIPE_READ;
