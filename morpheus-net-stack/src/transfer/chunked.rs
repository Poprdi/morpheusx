//! HTTP chunked transfer-encoding decoder (RFC 7230 §4.1).
...
impl ChunkedDecoder {
    ...
    /// One-shot decode; errors if the body is incomplete.
            ...
            match self.state {
                DecoderState::ReadingSize => {
                        ...
                        && self.size_buffer.last() == Some(&b'\r')
                    {
                        ...
                        // Cap to prevent DoS via unbounded size lines.
