//! Parse .morpheus section: a copy of .reloc that UEFI hasn't discarded.
...
pub unsafe fn find_embedded_reloc(
    ...
    let section_count =
        u16::from_le_bytes([*image_base.add(e_lfanew + 6), *image_base.add(e_lfanew + 7)]) as usize;
    ...
    for i in 0..section_count {
        ...
        if name.starts_with(b".morphe") {
            ...
            // Header: magic[4] | original_rva[4] | data_size[4] | data[..]
            ...
            return Ok(EmbeddedRelocData { original_rva, data });
        }
    }
