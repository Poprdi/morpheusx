...
use super::{PeError, PeResult, PeArch};
...
impl PeHeaders {
    ...
    pub unsafe fn reconstruct_original_image_base(
        ...
        let section_offset = self.dos.e_lfanew as usize + 24 + self.coff.size_of_optional_header as usize;
        ...
        let reloc_section = sections.find_reloc_section()
